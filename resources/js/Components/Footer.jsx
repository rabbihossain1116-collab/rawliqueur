...
export default function Footer() {
    return (
        <footer className="bg-[#fdf3ea] pt-10 sm:pt-[50px] md:pt-[60px]">
            <div className="max-w-[1160px] mx-auto px-5 sm:px-8 pb-8 sm:pb-10">
                {/* Top row: about spans full on mobile/tablet */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr_1.2fr] gap-6 sm:gap-7 md:gap-[30px]">
                    <div className="footer-about sm:col-span-2 lg:col-span-1">
                    ...
                    <div className="sm:col-span-2 lg:col-span-1">
                        ...
                        <div className="flex rounded-full overflow-hidden border border-[#e8dccb] max-w-[320px]">
